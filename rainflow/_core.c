...
#define __PYX_HAVE__rainflow___core
#define __PYX_HAVE_API__rainflow___core
/* Early includes */
#include <string.h>
#include <stdio.h>
#include "pythread.h"
...
/* Module declarations from 'rainflow._core' */
...
static CYTHON_INLINE PyObject *__pyx_f_8rainflow_5_core_path(__Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "rainflow._core"
extern int __pyx_module_is_main_rainflow___core;
int __pyx_module_is_main_rainflow___core = 0;

/* Implementation of 'rainflow._core' */
...
static PyObject *__pyx_pf_8rainflow_5_core_path(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_spectrum); /* proto */
...
static PyObject *__pyx_pw_8rainflow_5_core_1path(PyObject *__pyx_self, PyObject *__pyx_arg_spectrum); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_8rainflow_5_core_path(__Pyx_memviewslice __pyx_v_spectrum, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  int __pyx_v_temp;
  int __pyx_v_current_index;
  PyObject *__pyx_v_sub_spectrums = NULL;
  PyObject *__pyx_v_path = NULL;
  PyObject *__pyx_v_current_sub_spectrum = NULL;
 ...
 */
  ...
  /* "rainflow/_core.pyx":17
 *         int current_index=1 #
 *     #
 *     sub_spectrums = []  # type: list[list[float]]             # <<<<<<<<<<<<<<
 *     path = [0, 1]  #  0, 1
 *     while current_index!= <int>spectrum.shape[0]-1:   #
 */
  __pyx_t_1 = PyList_New(0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_sub_spectrums = ((PyObject*)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "rainflow/_core.pyx":18
 *     #
 *     sub_spectrums = []  # type: list[list[float]]
 *     path = [0, 1]  #  0, 1             # <<<<<<<<<<<<<<
 *     while current_index!= <int>spectrum.shape[0]-1:   #
 ...
 */
  ...
  /* "rainflow/_core.pyx":19
 *     sub_spectrums = []  # type: list[list[float]]
 *     path = [0, 1]  #  0, 1
 *     while current_index!= <int>spectrum.shape[0]-1:   #             # <<<<<<<<<<<<<<
 *         for i in range(current_index, <int>(spectrum.shape[0]-1)):
 *             if spectrum[i]<spectrum[current_index]<spectrum[i+1] or spectrum[i]>spectrum[current_index]>spectrum[i+1]:  #
 */
  while (1) {
    __pyx_t_2 = ((__pyx_v_current_index != (((int)(__pyx_v_spectrum.shape[0])) - 1)) != 0);
    if (!__pyx_t_2) break;

    /* "rainflow/_core.pyx":20
 *     path = [0, 1]  #  0, 1
 *     while current_index!= <int>spectrum.shape[0]-1:   #
 *         for i in range(current_index, <int>(spectrum.shape[0]-1)):             # <<<<<<<<<<<<<<
 *             if spectrum[i]<spectrum[current_index]<spectrum[i+1] or spectrum[i]>spectrum[current_index]>spectrum[i+1]:  #
 *                 current_sub_spectrum = array.array("d", [])  #
 */
    __pyx_t_3 = ((int)((__pyx_v_spectrum.shape[0]) - 1));
    __pyx_t_4 = __pyx_t_3;
    for (__pyx_t_5 = __pyx_v_current_index; __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
      __pyx_v_i = __pyx_t_5;

      /* "rainflow/_core.pyx":21
 *     while current_index!= <int>spectrum.shape[0]-1:   #
 *         for i in range(current_index, <int>(spectrum.shape[0]-1)):
 *             if spectrum[i]<spectrum[current_index]<spectrum[i+1] or spectrum[i]>spectrum[current_index]>spectrum[i+1]:  #             # <<<<<<<<<<<<<<
 *                 current_sub_spectrum = array.array("d", [])  #
 ...
 */
      __pyx_t_6 = __pyx_v_i;
      __pyx_t_7 = __pyx_v_current_index;
      __pyx_t_8 = (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_spectrum.data) + __pyx_t_7)) )));
      __pyx_t_9 = ((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_spectrum.data) + __pyx_t_6)) ))) < __pyx_t_8);
      if (__pyx_t_9) {
        __pyx_t_7 = (__pyx_v_i + 1);
        __pyx_t_9 = (__pyx_t_8 < (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_spectrum.data) + __pyx_t_7)) ))));
      }
      ...
      __pyx_t_7 = __pyx_v_current_index;
      __pyx_t_8 = (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_spectrum.data) + __pyx_t_7)) )));
      __pyx_t_10 = ((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_spectrum.data) + __pyx_t_6)) ))) > __pyx_t_8);
      if (__pyx_t_10) {
        __pyx_t_7 = (__pyx_v_i + 1);
        __pyx_t_10 = (__pyx_t_8 > (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_spectrum.data) + __pyx_t_7)) ))));
      }
 ...
 */
        ...
        __pyx_t_1 = 0;
        __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)__pyx_ptype_7cpython_5array_array), __pyx_t_11, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 22, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
        __Pyx_XDECREF_SET(__pyx_v_current_sub_spectrum, __pyx_t_1);
        __pyx_t_1 = 0;

        /* "rainflow/_core.pyx":23
 *             if spectrum[i]<spectrum[current_index]<spectrum[i+1] or spectrum[i]>spectrum[current_index]>spectrum[i+1]:  #
 *                 current_sub_spectrum = array.array("d", [])  #
 *                 for temp in range(current_index, i+1):             # <<<<<<<<<<<<<<
 *                     current_sub_spectrum.append(spectrum[temp])
 *                 current_sub_spectrum.append(spectrum[current_index])  #
 */
        __pyx_t_12 = (__pyx_v_i + 1);
        __pyx_t_13 = __pyx_t_12;
        for (__pyx_t_14 = __pyx_v_current_index; __pyx_t_14 < __pyx_t_13; __pyx_t_14+=1) {
          __pyx_v_temp = __pyx_t_14;

          /* "rainflow/_core.pyx":24
 *                 current_sub_spectrum = array.array("d", [])  #
 *                 for temp in range(current_index, i+1):
 *                     current_sub_spectrum.append(spectrum[temp])             # <<<<<<<<<<<<<<
 *                 current_sub_spectrum.append(spectrum[current_index])  #
 *                 sub_spectrums.append(current_sub_spectrum) #
 */
          __pyx_t_6 = __pyx_v_temp;
          __pyx_t_1 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_spectrum.data) + __pyx_t_6)) )))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 24, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_1);
          __pyx_t_15 = __Pyx_PyObject_Append(__pyx_v_current_sub_spectrum, __pyx_t_1); if (unlikely(__pyx_t_15 == ((int)-1))) __PYX_ERR(0, 24, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        }

        /* "rainflow/_core.pyx":25
 *                 for temp in range(current_index, i+1):
 *                     current_sub_spectrum.append(spectrum[temp])
 *                 current_sub_spectrum.append(spectrum[current_index])  #             # <<<<<<<<<<<<<<
 *                 sub_spectrums.append(current_sub_spectrum) #
 * 
 */
        __pyx_t_6 = __pyx_v_current_index;
        __pyx_t_1 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_spectrum.data) + __pyx_t_6)) )))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 25, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        __pyx_t_15 = __Pyx_PyObject_Append(__pyx_v_current_sub_spectrum, __pyx_t_1); if (unlikely(__pyx_t_15 == ((int)-1))) __PYX_ERR(0, 25, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

        /* "rainflow/_core.pyx":26
 *                     current_sub_spectrum.append(spectrum[temp])
 *                 current_sub_spectrum.append(spectrum[current_index])  #
 *                 sub_spectrums.append(current_sub_spectrum) #             # <<<<<<<<<<<<<<
 * 
 *                 path.append(i+1)
 */
        __pyx_t_15 = __Pyx_PyList_Append(__pyx_v_sub_spectrums, __pyx_v_current_sub_spectrum); if (unlikely(__pyx_t_15 == ((int)-1))) __PYX_ERR(0, 26, __pyx_L1_error)

        /* "rainflow/_core.pyx":28
 *                 sub_spectrums.append(current_sub_spectrum) #
 * 
 *                 path.append(i+1)             # <<<<<<<<<<<<<<
 *                 current_index = i+1
 *                 break
 */
        __pyx_t_1 = __Pyx_PyInt_From_long((__pyx_v_i + 1)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 28, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        __pyx_t_15 = __Pyx_PyList_Append(__pyx_v_path, __pyx_t_1); if (unlikely(__pyx_t_15 == ((int)-1))) __PYX_ERR(0, 28, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

        /* "rainflow/_core.pyx":29
 * 
 *                 path.append(i+1)
 *                 current_index = i+1             # <<<<<<<<<<<<<<
 *                 break
 *             if i == <int>(spectrum.shape[0]-2): #
 */
        __pyx_v_current_index = (__pyx_v_i + 1);

        /* "rainflow/_core.pyx":30
 *                 path.append(i+1)
 *                 current_index = i+1
 *                 break             # <<<<<<<<<<<<<<
 *             if i == <int>(spectrum.shape[0]-2): #
 ...
 */
      __pyx_t_2 = ((__pyx_v_i == ((int)((__pyx_v_spectrum.shape[0]) - 2))) != 0);
      if (__pyx_t_2) {

        /* "rainflow/_core.pyx":32
 *                 break
 *             if i == <int>(spectrum.shape[0]-2): #
 *                 current_index += 1             # <<<<<<<<<<<<<<
 *                 path.append(current_index)
 ...
 */
        __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_current_index); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 33, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        __pyx_t_15 = __Pyx_PyList_Append(__pyx_v_path, __pyx_t_1); if (unlikely(__pyx_t_15 == ((int)-1))) __PYX_ERR(0, 33, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  __Pyx_INCREF(__pyx_v_sub_spectrums);
  __Pyx_GIVEREF(__pyx_v_sub_spectrums);
  PyTuple_SET_ITEM(__pyx_t_1, 1, __pyx_v_sub_spectrums);
 ...
 */
  ...
  __Pyx_AddTraceback("rainflow._core.path", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_sub_spectrums);
  __Pyx_XDECREF(__pyx_v_path);
  __Pyx_XDECREF(__pyx_v_current_sub_spectrum);
...
/* Python wrapper */
static PyObject *__pyx_pw_8rainflow_5_core_1path(PyObject *__pyx_self, PyObject *__pyx_arg_spectrum); /*proto*/
static char __pyx_doc_8rainflow_5_core_path[] = "path(double[::1] spectrum) -> tuple\ndef path(spectrum: numpy.ndarray) -> tuple\n    \n    :param spectrum: \350\275\275\350\215\267\350\260\261 \344\270\200\347\273\264\350\277\236\347\273\255\346\225\260\347\273\204\n    :return: \346\234\254\346\254\241\351\233\250\346\265\201\347\273\217\350\277\207\350\212\202\347\202\271\347\232\204\347\264\242\345\274\225 \345\222\214\344\272\247\347\224\237\347\232\204\345\255\220\351\233\250\346\265\201\n    ";
static PyObject *__pyx_pw_8rainflow_5_core_1path(PyObject *__pyx_self, PyObject *__pyx_arg_spectrum) {
  ...
  assert(__pyx_arg_spectrum); {
    __pyx_v_spectrum = __Pyx_PyObject_to_MemoryviewSlice_dc_double(__pyx_arg_spectrum, PyBUF_WRITABLE); if (unlikely(!__pyx_v_spectrum.memview)) __PYX_ERR(0, 7, __pyx_L3_error)
  }
  ...
  __pyx_r = __pyx_pf_8rainflow_5_core_path(__pyx_self, __pyx_v_spectrum);
...
static PyObject *__pyx_pf_8rainflow_5_core_path(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_spectrum) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("path", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_spectrum.memview)) { __Pyx_RaiseUnboundLocalError("spectrum"); __PYX_ERR(0, 7, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_8rainflow_5_core_path(__pyx_v_spectrum, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "rainflow._core.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "rainflow._core._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"path", (PyCFunction)__pyx_pw_8rainflow_5_core_1path, METH_O, __pyx_doc_8rainflow_5_core_path},
  {0, 0, 0, 0}
};
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_rainflow___core) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "rainflow._core")) {
      if (unlikely(PyDict_SetItemString(modules, "rainflow._core", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init rainflow._core", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init rainflow._core");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
